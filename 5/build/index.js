      ...
      218: (e, t, n) => {
        ...
        function J(e, t, n) {
          ...
          function u(e, n, o) {
            ...
            return !!I(e) || (t.append(z(o, n, s), c(e)), !1);
          }
          const l = [],
            f = Object.assign(H, {
              defaultVisitor: u,
                  ...
                  B.forEach(n, function (n, s) {
                    !0 ===
                      (!(B.isUndefined(n) || null === n) &&
                        o.call(t, n, B.isString(s) ? s.trim() : s, r, f)) &&
                      e(n, r ? r.concat(s) : [s]);
                  }),
                  l.pop();
              }
        ...
        const Le = (function e(t) {
          ...
          return (
            B.extend(o, je.prototype, n, { allOwnKeys: !0 }),
  ...
  (n.g = (function () {
    ...
    (() => {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        const t = document.querySelector(".button-component button"),
          n = document.querySelector("#root");
        null !== t &&
          t.addEventListener("click", async function () {
            const t = await e.get("https://jsonplaceholder.typicode.com/users"),
              r = t.data[0];
            console.log({ users: t, user: r }),
              (function (e) {
                const t = document.createElement("h1");
                t.classList.add("title-component"),
                  (t.innerHTML = `<h1>${JSON.stringify(e)}</h1>`),
                  n.prepend(t);
              })(r);
          });
      });
